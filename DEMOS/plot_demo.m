...
image=stir.FloatVoxelsOnCartesianGrid.read_from_file('DEMOS/recon_test_pack/test_image_3.hv');
...
projdata=stir.ProjData.read_from_file('DEMOS/recon_test_pack/SPECT/input.hs');
